...
부적합과 권고사항(또는 “개선 기회, Observation / OFI”)은 평가 및 관리 시스템 운영 시 자주 혼동되는 개념이므로, 구별 기준을 명확히 두는 것이 중요합니다. 아래 기준들을 중심으로 설명드립니다. (1) ISO 관점: 권고사항/개선기회는 정의된 용어가 아님 ISO 9000 / ISO 19011 / ISO 17021 등의 표준에는 “Opportunity for Improvement / Recommendation” 이라는 용어의 공식 정의는 없습니다. 심사 지침에서는 심사원이 부적합을 지적으로 할 수 없는 경우라도 시스템 개선 가능성 등에 대해 의견을 제시할 수 있음을 인정하지만, 권고사항은 의무 조치 항목은 아니다 라는 점이 강조됩니다. ISO/IEC 17021-1:2015 (인증기관에 대한 요구사항)에서는 관찰(observation) 또는 개선 기회가 식별되고 기록될 수 있으나, 평가 결과가 nonconformity인 경우에는 그것을 개선 기회로 기록해서는 안 된다고 정의하고 있으며, 개선 기회는 표준 위반의 증거가 없는 영역에서 제시 가능한 조언 수준으로 다루어 지고 있습니다. ISO 19011:2018 제6.4.10항에서는 “recommendations (권고사항)” 또는 “opportunities for improvement”는 심사 목적에 따라 제시될 수 있지만, 이는 성능 개선을 위한 의견이지 필수 준수 대상은 아니라고 명시합니다. 즉, ISO 체계에서는 권고사항 또는 개선기회는 평가사(심사원)이 제안할 수 있는 개선 아이디어 수준이며, 부적합과는 별도로 취급됩니다. (2) 실무적/판단 기준으로의 구별 요소*** 아래 요소들을 기준으로 “이건 부적합인가, 개선 기회인가”를 구별하는 것이 일반적입니다: | 구별 기준 | 부적합 (Nonconformity) | 권고사항 / 개선기회 (OFI, Recommendation) | | -------------------- | ---------------------------------- | --------------------------------------- | | **요구사항 위반 여부** | 기준 또는 요구사항을 명백히 위반한 경우 | 요구사항을 위반하지 않았지만 더 나은 방법이 있을 경우 | | **의무 조치 여부** | 반드시 시정 조치가 요구됨 | 조치가 의무는 아니며 조직의 선택 사항 | | **인증 또는 적합성 영향 가능성** | 인증 유지, 시스템 신뢰성 등에 영향을 줄 수 있음 | 일반적으로 인증 불이행으로 직접 연결되지는 않음 | | **심각성 / 위험도** | 시스템 취약, 반복 발생, 안전/품질 영향 등 | 주로 효율성, 최적화, 비용 절감 등 개선 여지 | | **명령적 표현 사용 여부** | “~하지 않음”, “~이 없음”, “~미준수” 등 부정적 표현 | “~필요함”, “권장됨”, “검토할 필요 있음” 등 제안형 표현 | """)
